...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/de-tagesschau-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/de-tagesschau-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add de-tagesschau
# for installing globally
pixi global install de-tagesschau
```
...
It is possible to list all of the versions of `de-tagesschau` available on your platform:
...
```
pixi search de-tagesschau --channel conda-forge
```
